				...
				<ul class="nav ace-nav">
							...
							<li class="dropdown-content">
								<ul class="dropdown-menu dropdown-navbar">
									<li><a href="#" class="clearfix"> <img
											src="<c:url value="/static/avatars/avatar.png" />"
									...
									<li><a href="#" class="clearfix"> <img
											src="<c:url value="/static/avatars/avatar3.png" />"
									...
									<li><a href="#" class="clearfix"> <img
											src="<c:url value="/static/avatars/avatar4.png" />"
									...
									<li><a href="#" class="clearfix"> <img
											src="<c:url value="/static/avatars/avatar2.png" />"
									...
									<li><a href="#" class="clearfix"> <img
											src="<c:url value="/static/avatars/avatar5.png" />"
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <img class="nav-user-photo"
							src="<c:url value="/static/avatars/user.jpg"/>"
		...
		<div class="footer">
			<div class="footer-inner">
				<div class="footer-content">
					<span class="bigger-120"> <span class="blue bolder">KMS</span>
