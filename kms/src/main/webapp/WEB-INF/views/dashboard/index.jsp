<template:basic htmlTitle="Profile" bodyTitle="Profile">  
 <div class="row">
     <div class="col-sm-12">
         <div class="bg-picture text-center" style="background-image:url('<c:url value='/static/images/big/bg.jpg' />')">
             <div class="bg-picture-overlay"></div>
             <div class="profile-info-name">
                 <img src="<c:url value="/static/images/avatar-1.jpg" />" class="thumb-lg img-circle img-thumbnail" alt="profile-image">
                 <h3 class="text-white">${user.firstName}</h3>
             </div>
         </div>
         <!--/ meta -->
     </div>
